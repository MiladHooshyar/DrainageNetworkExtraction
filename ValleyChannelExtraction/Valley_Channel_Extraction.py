...
def main(TauDEM_path , output_folder_path , DEM_file_path, cell_size, unit, \
        ...
        print '1. Filtering'
        Valley_Fun.Perona_malik(map_file_path + '\\Org_Dem.tif' , map_file_path + '\\Smooth_Dem.tif' , num_iter  , cell_size , 'PM2')

        print '2. Computing Curvature'
        Valley_Fun.curvature(map_file_path + '\\Smooth_Dem.tif' , map_file_path + '\\Curvature.tif' , map_file_path + '\\Curvature_profile.tif' ,cell_size, 'POLY_CON')

        print '3. Making Valley & Ridge Skeletons'
        sig_thresh  = Valley_Fun.neg_bond(map_file_path + '\\Curvature.tif' , map_file_path + '\Valley_Bond.tif' ,   map_file_path + '\\Ridge_Bond.tif' , map_file_path + '\\Conv_Sig.tif' , map_file_path + '\\Dive_Sig.tif')
        ...
        Valley_Fun.flow_dir( map_file_path + '\\Fill_Dem.tif',  map_file_path + '\\Fdir_inf.tif' , map_file_path + '\\Slope_inf.tif' , 'DINF')
        Valley_Fun.Dinf_fix(map_file_path + '\\Fdir_inf.tif', map_file_path + '\\Curvature.tif' , map_file_path + '\\Modified_Fdir_inf.tif')
        Valley_Fun.flow_acc(map_file_path + '\\Modified_Fdir_inf.tif', map_file_path + '\\Modified_Facc_inf.tif' , 'DINF')
        Valley_Fun.Dinf_to_D8(map_file_path + '\\Modified_Facc_inf.tif' , map_file_path + '\\Modified_Fdir_8.tif' , map_file_path + '\\Modified_Facc_8.tif')
        Valley_Fun.cut_dem(map_file_path, map_file_path ,	'Modified_Fdir_8.tif' ,'Valley_Bond.tif' ,   'Cut_Modified_Fdir_8.tif')
        Valley_Fun.flow_acc_weigth(map_file_path + '\\Cut_Modified_Fdir_8.tif', map_file_path + '\\Curvature.tif',  map_file_path + '\\Cut_Modified_Facc_8.tif' , 'D8')
        ...
        Valley_Fun.stream_order(map_file_path, map_file_path, 'Temp_Valley_00.tif' ,   'Cut_Modified_Fdir_8.tif' ,   'Temp_Order_00.tif')
        Valley_Fun.delet_isolated_stream(map_file_path , map_file_path, 'Temp_Valley_00.tif' , 'Temp_Order_00.tif' , 'Modified_Fdir_8.tif','Modified_Facc_8.tif' , 2 , 2  , 'Temp_Valley_000.tif')
        num_add = Valley_Fun.connect_stream_smart(map_file_path , map_file_path, 'Temp_Valley_000.tif' ,'Modified_Fdir_8.tif',  'Curvature.tif',  'Temp_Valley_10.tif' ,  connect_ratio)


        print '5. Thining & Connecting Valley Skeleton'
        trial = 0
        num_deleted = 1
        num_deleted_0 = 0
        num_add  = 1
        ...
        while num_add  != num_add_0 and num_deleted != num_deleted_0:
                ...
                num_deleted = Valley_Fun.stream_delet_small_fast(map_file_path , map_file_path ,	'Ridge_Bond.tif' , in_stream ,	'Fill_Dem.tif' \
                ,'Modified_Fdir_8.tif' ,'Modified_Facc_8.tif' , order_raster ,  'Curvature.tif', out_stream)
                num_add = Valley_Fun.connect_stream_smart(map_file_path , map_file_path, out_stream ,'Modified_Fdir_8.tif','Curvature.tif',  con_out_stream ,  connect_ratio)
                trial = trial + 1
        ...
        Valley_Fun.stream_order(map_file_path, map_file_path,	  in_stream  ,'Modified_Fdir_8.tif' ,   order_raster)
        Valley_Fun.delet_isolated_stream(map_file_path , map_file_path, in_stream , order_raster , 'Modified_Fdir_8.tif','Modified_Facc_8.tif' , 200 , 2  , 'Valley_Network.tif')
        ...
        Valley_Fun.stream_to_line(map_file_path, map_file_path, 'Valley_Network.tif' , 'Modified_Fdir_8.tif' , 'Valley_Network.shp')
